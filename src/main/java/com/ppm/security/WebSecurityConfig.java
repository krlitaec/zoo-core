...
import com.ppm.security.services.UsuarioServicioImpl;
import com.ppm.security.token.AuthEntryPointJwt;
import com.ppm.security.token.AuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                //.antMatchers("/api/animales/**").permitAll()
