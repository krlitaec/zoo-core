...
public final class SecurityUtils {
    ...
    public static Optional<Integer> getCurrentUserId() {
        ...
        if (securityContext.getAuthentication() != null) {
            if (securityContext.getAuthentication().getPrincipal() instanceof UsuarioImpl) {
                UsuarioImpl usuario = (UsuarioImpl) securityContext.getAuthentication().getPrincipal();
